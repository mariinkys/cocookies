...
pub fn ViewEditIngredientsComponent(recipe_id: i32) -> impl IntoView {
    ...
    view! {
        <div class="w-full card shadow-xl">
            <div class="card-body">
                { move || {
                    // TODO: When you refresh the page something inside here causes hydration errors
                                        ...
                                        <div class="card-body">
                                            <ActionForm action=update_recipe_ingredient>
                                                ...
                                                <div class="flex gap-2 items-center">
                                                    ...
                                                    <button type="submit" class="btn btn-primary mt-[20px] w-min">"Update"</button>
                                                </div>
                                            </ActionForm>
                                        </div>
                                    </div>
